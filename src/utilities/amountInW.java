 ...
 * @author Marek
 */
public class amountInW {
    public static String amountInWords(float kwota){
        String words = " ";
        float kw = Math.round(kwota*100);
        int kwotaInt = (int) kw;
        int poz1 = kwotaInt / 10000000;
        kwotaInt = kwotaInt - 10000000 * poz1;
        int poz2 = kwotaInt / 1000000;
        kwotaInt = kwotaInt - 1000000 * poz2;
        int poz3 = kwotaInt / 100000;
        kwotaInt = kwotaInt - 100000 * poz3;
        int poz4 = kwotaInt / 10000;
        kwotaInt = kwotaInt - 10000 * poz4;
        int poz5 = kwotaInt / 1000;
        kwotaInt = kwotaInt - 1000 * poz5;
        int poz6 = kwotaInt / 100;
        kwotaInt = kwotaInt - 100 * poz6;
        int ppoz1 = kwotaInt / 10;
        kwotaInt = kwotaInt - 10 * ppoz1;
        int ppoz2 = kwotaInt / 1;
